...
Premium
    ...
    "relative flex min-h-68 w-full flex-col rounded-2xl border bg-white-c p-4 text-center",
    item.equipe ? "border-3 border-paprika-c" : "border border-beige-c"
