...
const $$Connexion = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(["", ' <script type="module" src="/src/js/connexion.js"><\/script>'])), renderComponent($$result, "Layout", $$LayoutLandingpage, {}, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, { "title": "Connexion" })} ${maybeRenderHead()}<main class="flex items-center justify-center px-6 py-10"> <section class="w-full max-w-xl"> <div class="mb-10 rounded-3xl bg-white-c px-5 py-5"> <h3 class="text-paprika-c">Connecte-toi !</h3> </div> <form id="form-login" method="post" class="rounded-3xl bg-white-c px-5 py-5 flex flex-col gap-6"> <label class="block font-bold">
Email
...
Mot de passe
<div class="relative mt-2"> <input id="password" name="password" type="password" required class="w-full rounded-xl border-2 border-yellow-c bg-white-bk px-4 py-3 pr-14 font-normal outline-none focus:border-paprika-c"> <button type="button" id="toggle-password" class="absolute right-4 top-1/2 -translate-y-1/2"> ${renderComponent($$result2, "Image", $$Image, { "id": "eye-icon", "src": Eye, "alt": "", "class": "w-5 h-5" })} </button> </div> </label> <div id="retour-login"${addAttribute([
