...
import { I as Instagram, T as Tiktok, F as Facebook } from '../chunks/tiktok_epX9F8PE.mjs';
...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a || (_a = __template(["", ' <script type="module" src="/src/js/contact.js"><\/script>'])), renderComponent($$result, "Layout", $$Layout, { "title": "Contact" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="px-8 py-10"> <a href="/" class="inline-flex items-center gap-3 rounded-full bg-orange-c/70 px-6 py-3 text-white"> ${renderComponent($$result2, "Image", $$Image, { "src": Fleche, "alt": "", "class": "w-4 h-4" })}
Retour
...
</p> </section> <section class="mt-16 rounded-lg border border-mocha-c bg-white-c px-6 py-8"> <form id="contact-form" class="flex flex-col gap-8"> <label class="block font-bold">
Nom complet *
...
Message *
<textarea name="message" required placeholder="Écrivez votre message ici..." rows="7" class="mt-4 w-full resize-none rounded-lg border border-yellow-c bg-white-bk px-5 py-4 font-normal placeholder:text-marron-c outline-none focus:border-paprika-c"></textarea> </label> <div id="retour-contact" class="hidden rounded-lg px-4 py-3 font-semibold"></div> <button type="submit" id="btn-contact" class="relative mx-auto mt-2 flex w-72 items-center justify-center rounded-full bg-paprika-c py-4 text-white-bk"> <span class="absolute inset-y-0 left-4 flex items-center"> ${renderComponent($$result2, "Image", $$Image, { "src": Flechegauche, "alt": "", "class": "h-12 w-12" })} </span>
Envoyer le message
...
</small> <div class="mt-4 flex justify-center gap-4"> <a href="/" class="flex h-15 w-15 items-center justify-center rounded-2xl bg-paprika-c"> ${renderComponent($$result2, "Instagram", Instagram, { "class": "h-11 w-11 text-white" })} </a> <a href="/" class="flex h-15 w-15 items-center justify-center rounded-2xl bg-paprika-c"> ${renderComponent($$result2, "Tiktok", Tiktok, { "class": "h-11 w-11 text-white" })} </a> <a href="/" class="flex h-15 w-15 items-center justify-center rounded-2xl bg-paprika-c"> ${renderComponent($$result2, "Facebook", Facebook, { "class": "h-11 w-11 text-white" })} </a> </div> </section> </main> ` }));
