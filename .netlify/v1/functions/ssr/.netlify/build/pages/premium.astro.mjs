...
import 'clsx';
import { l as loadAstroAuth, B as getAbonnements, C as getAvantages, D as getFaq } from '../chunks/backend_CNX6c8lU.mjs';
...
<span class="absolute inset-y-0 right-4 flex items-center"> ${renderComponent($$result2, "Image", $$Image, { "src": Flechedroite, "alt": "", "class": "h-12 w-12" })} </span> </a> </div> </section> <section class="mt-16"> <h3 class="text-center text-paprika-c">Le kit du parfait fêtard</h3> <div class="mt-8 space-y-6"> ${renderComponent($$result2, "Card", $$AvantageCard, { "titre": "-20% sur la boutique", "description": "R\xE9duction exclusive sur tous les articles de la boutique" })} ${avantages.map((avantage) => renderTemplate`${renderComponent($$result2, "Card", $$AvantageCard, { "titre": avantage.titre, "description": avantage.description })}`)} </div> </section> <section class="mt-16"> <div class="rounded-2xl border-2 border-yellow-c bg-white-c p-8"> <h3 class="text-paprika-c">Questions fréquentes</h3> <div class="mt-10 space-y-10"> ${faq.map((item) => renderTemplate`${renderComponent($$result2, "FaqCard", $$FaqCard, { "question": item.question, "reponse": item.reponse })}`)} </div> </div> </section> </div> </main> ` })}`;
